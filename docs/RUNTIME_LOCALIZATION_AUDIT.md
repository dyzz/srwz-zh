...
`4cf9a6c3645e36d795499622787443c539b3ad09898715244b226d9065d7eb6b`；实际滚动条
显示仍由用户在该精确 ISO 上验收。
...
| 武器详情“特殊效果2” | NISVDATA chunk 6 的三份效果名表 | `屏障贯通`、`无视体型修正`，共 6 处 | 已回读 |
...
2. 人物／机体图鉴正文、用语事典、音乐选择、剧情流程和攻略 Q&A 已正式纳入
   v0.2.0；完整边界与曲名保留规则见 `LIBRARY_V02_SCOPE.md`。它们应先按领域建立
   完整清单，再批量翻译和审校，避免用截图逐条散改。游戏内教程仍是单独范围。
