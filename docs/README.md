...
当前文档包含 v0.4.1 双版本发布说明、可执行构建流程、工程约束和带日期的历史验证记录。
...
维护命令；v0.4.1 发布入口以 `RELEASE_BUILD_V0.4.1.md` 为准。
...
| [BATTLE_SQUARE_SKIP.md](BATTLE_SQUARE_SKIP.md) | 战斗演出引擎结构、□ 跳段补丁实现与验证、○ 快进机制分析、Z2 式直接跳转原型记录 |
