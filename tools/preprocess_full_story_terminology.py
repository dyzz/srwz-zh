...
def curated_rules() -> list[dict[str, object]]:
    ...
    return [
        ...
        rule("wiki-ergo", "超重神 GRAVION", "technology", ["エルゴ"], ["Ergo", "Ergo Break", "Ergo Fooooooorm"], "工学（Ergo）", "auto_wiki_subtitle", "medium", "中文对齐资料将 Ergo Form/Break 译为工学状态/工学分裂；具体组合按句处理。", [local("work/review/sources/robinfo-works/85-zh-TW.md", "工学状态 / 工学分裂")]),
        ...
        rule("project-the-end", "交响诗篇", "unit", ["ジ・エンド"], ["The End"], "尼尔瓦修 the END", "auto_project", "high", "项目显示名已有尼尔瓦修 the END。", [local("corpus/zh/display-names/units-full.json", "项目显示名 尼尔瓦修 the END")]),
        ...
        rule("project-garia", "战斗机甲萨芬格尔", "unit", ["ギャリア"], ["Garia"], "加里亚", "auto_project", "medium", "原文为沃克·加里亚的简称；项目完整显示名为沃克·加里亚。", [local("corpus/zh/display-names/units-full.json", "项目显示名 沃克·加里亚")]),
        ...
        rule("project-walker-machine", "战斗机甲萨芬格尔", "unit", ["ウォーカーマシン"], ["Walker Machine"], "Walker Machine", "auto_project", "medium", "项目 UI 已明确暂保留英文，下载字幕也出现英文；后续若取得官方简中再整体替换。", [local("corpus/zh/menu/system-ui-parts.json", "项目注记暂保留 Walker Machine"), local("work/review/subtitle-sources/xabungle", "字幕出现 Walker Machine")]),
