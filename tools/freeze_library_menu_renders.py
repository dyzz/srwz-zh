#!/usr/bin/env python3
"""Explicitly render and freeze the reviewed JTIM LIBRARY menu labels."""
...
DEFAULT_OUTPUT = (
    PROJECT_ROOT / "config/library/library-menu-render-snapshot.json"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Explicitly rerender and freeze the LIBRARY main menu."
    )
...
def main() -> int:
    ...
    contract = config["library_menu_tim2"]
    member_lock = config["source_member_locks"]["DATA/JTIM.BIN"]
    ...
    snapshot: dict = {}
    _output, report = build_jtim_library_menu(
        source,
        contract,
    ...
    preview = WORK_ROOT / "refreeze/library-menu/library-menu.png"
