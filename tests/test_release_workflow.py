...
class ReleaseWorkflowTest(unittest.TestCase):
    ...
    def test_v030_043_remaining_site_feedback_adjustments(self) -> None:
        ...
        story_expected = {
            ...
            "story/016/dialogue/01.15/0004": "“你、你在胡说什么！”",
    ...
    def test_v030_042_escape_wording_is_context_bound(self) -> None:
        story_expected = {
            ...
            "story/083/dialogue/01.20/0004": "“快逃生，老把头！那台机体撑不住了！”",
    ...
    def test_zambot_weapon_terms_follow_approved_community_wording(self) -> None:
        ...
        expected_battle = {
            "battle:22828": "“赞波特冲击镖！！”",
            "battle:22844": "“赞波特突击枪！！”",
            "battle:22847": "“让你见识一下华丽的赞波特钗格斗技！”",
            "battle:22848": "“这里该用突击枪，嘿呀！！”",
            "battle:22856": "“赞波特\\n　月环攻击——！！”",
            "battle:22857": "“用月环攻击一口气解决，\\n　胜平！”",
            "battle:22859": "“月环攻击！！”",
