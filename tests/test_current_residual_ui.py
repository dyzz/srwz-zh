...
class CurrentResidualUiTests(unittest.TestCase):
    ...
    def test_fixed_slps_and_suspend_return_dialogue_are_locked(self):
        ...
        self.assertEqual(
            ...
            "33339cf8fbaeefe1b76e45b4effecd7c696b3df07ffdcfa1db3886966082b52c",
        )
        translations = {
        ...
        self.assertEqual(translations["グローリー・スター"], "荣耀之星")
