...
CONFIG_PATH = (
    PROJECT_ROOT
    / "config/iso/"
    "ui-p7-embedded-font-groups-first-five-atlas-test-build.json"
)
...
class UiP7TestCandidateIsoTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_static_iso_report_and_manifest_are_exact(self):
        ...
        self.assertEqual(
            self.runtime["iso_build"]["output"],
            {
                "size": 3758456832,
                "sha256": (
                    "743b26bf2ad211e65a9a56638f295ceca5f53c965b4435a8"
                    "a9b5ed6ac4882348"
                ),
            },
        )
    ...
    def test_runtime_boundary_is_explicit(self):
        self.assertEqual(
            self.runtime["status"],
            (
                "static_integrated_ui_p7_embedded_font_groups_first_five_"
