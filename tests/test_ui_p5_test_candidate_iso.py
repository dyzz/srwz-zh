...
CONFIG_PATH = (
    PROJECT_ROOT
    / "config/iso/ui-p5-battle-menus-first-five-atlas-test-build.json"
)
...
RUNTIME_MANIFEST_PATH = (
    PROJECT_ROOT
    / "manifests/ui-p5-battle-menus-first-five-atlas-test-runtime-validation.json"
)


class UiP5TestCandidateIsoTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_static_iso_report_and_manifest_are_exact(self):
        ...
        self.assertEqual(
            self.runtime["iso_build"]["output"],
            {
                "size": 3758456832,
                "sha256": (
                    "2abecf4261b0a2a89c206bb64cdbd1c5f4908b43ad276823"
                    "cba18a795bc2bf73"
                ),
            },
        )
    ...
    def test_runtime_boundary_is_explicit(self):
        self.assertEqual(
            self.runtime["status"],
            (
                "static_integrated_ui_p5_battle_menus_first_five_atlas_test_"
